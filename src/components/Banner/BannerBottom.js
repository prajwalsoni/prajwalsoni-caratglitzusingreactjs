...
const BannerBottom = () => {
  ...
  <span className="font-bold font-titleFont w-6 text-center text-red">1-</span>
  <p className="text-lightText text-base text-red">Brand Have Lifetime Exchange Policy</p>
    </div>
   <div className="flex md:w-auto items-center gap-2 w-72 shadow-sm hover:shadow-md duration-300">
          ...
          <p className="text-lightText text-base">International shipping  & Luxury Shipping </p>
        </div>
        <div className="flex md:w-auto items-center gap-2 w-72 shadow-sm hover:shadow-md duration-300">
